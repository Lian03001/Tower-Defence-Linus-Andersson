...
namespace Template
{
    ...
    public class Game1 : Game
    {
        ...
        Rectangle Road1 = new Rectangle(0, 60, 445, 61);
        Rectangle Road2 = new Rectangle(385, 60, 61, 160);
        Rectangle Road3 = new Rectangle(385, 220, 225, 61);
        Rectangle Road4 = new Rectangle(550, 60, 61, 220);
        Rectangle Road5 = new Rectangle(550, 60, 190, 61);
        Rectangle Road6 = new Rectangle(680, 60, 61, 360);
        Rectangle Road7 = new Rectangle(0, 360, 740, 61);
        ...
        public void SpawnMinion(float x_p, float y_p, float x_s, float y_s, int hp)
        {
            Minion Minion1 = new Minion(x_p, y_p, x_s, y_s, hp);
            minions.Add(Minion1);
            minions.Count();
        }
        /// <summary>
